...
class AdoptChatScreen extends StatefulWidget {
  @override
  _AdoptChatScreenState createState() => _AdoptChatScreenState();
}

class _AdoptChatScreenState extends State<AdoptChatScreen> {
